...
import com.example.myfirstapp.Model.Chats;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.layoutofuser, parent, false);
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Intent internt = new Intent(context, MessageActivity.class);
            internt.putExtra("friendid",friendid);
            Toast.makeText(context,"ID is: " + friendid,Toast.LENGTH_SHORT).show();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    if (currentUser!=null &&  chats!=null) {
                        ...
                        if (chats.getSender().equals(friendid) && chats.getReciever().equals(currentUser.getUid()) ||
                                chats.getSender().equals(currentUser.getUid()) && chats.getReciever().equals(friendid)) {
